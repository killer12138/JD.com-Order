    ...
    <div className="mt-wrapper">
      ...
      <div className="mt-page" ref={pageRef}>
        ...
        <div className="mt-statusbar">
          ...
          <div className="mt-statusbar-icons">
            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
              <rect x="2" y="8" width="3" height="13" rx="1" />
              <rect x="7" y="5" width="3" height="16" rx="1" />
              <rect x="12" y="2" width="3" height="19" rx="1" />
              <rect x="17" y="0" width="3" height="21" rx="1" opacity="0.3" />
            </svg>
            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
        ...
        <div className="mt-navbar">
          ...
          <div className="navbar-right">
            ...
            <svg className="icon-refresh" viewBox="0 0 1024 1024" width="22" height="22">
              <path
                d="M925.696 515.072c0-229.376-186.368-414.72-414.72-414.72-164.864 0-307.2 96.256-374.272 235.52L64 289.28V512h222.72l-88.576-88.576C257.536 303.104 373.76 218.112 512 218.112c163.84 0 296.96 133.12 296.96 296.96 0 163.84-133.12 296.96-296.96 296.96-89.088 0-168.96-39.424-223.232-101.376l-82.944 82.944C284.672 884.48 392.192 928.768 512 928.768c229.376 0 413.696-185.344 413.696-413.696z"
                fill="#333333"
              />
            </svg>
          </div>
        ...
        <div className="mt-status-section">
          ...
          <p className="mt-status-subtitle">
            {orderData.statusDesc || '感谢您对美团外卖的信任，期待再次光临。'}
          </p>
        ...
        <div className="mt-actions-section">
          <div className="mt-action-item">
            <span className="action-text-only">更多</span>
          </div>
          <div className="mt-action-btn">
            <span className="action-btn-text">打赏骑手</span>
          </div>
          <div className="mt-action-btn">
            <span className="action-btn-text">联系商家</span>
          </div>
          <div className="mt-action-btn mt-action-highlight">
            <span className="action-btn-text action-text-orange">再来一单</span>
          </div>
        </div>
        ...
        <div className="mt-card" style={{ marginTop: '8px' }}>
          ...
          <div className="mt-expand-row">
            ...
            <svg className="expand-arrow expand-arrow-up" viewBox="0 0 1024 1024" width="14" height="14">
              <path
                d="M512 309.333c8.533 0 17.067 2.134 23.467 8.534l341.333 341.333c12.8 12.8 12.8 32 0 44.8s-32 12.8-44.8 0L512 384l-320 320c-12.8 12.8-32 12.8-44.8 0s-12.8-32 0-44.8l341.333-341.333c6.4-6.4 14.934-8.534 23.467-8.534z"
                fill="#999999"
              />
            </svg>
          </div>
        ...
        <div className="mt-card">
          ...
          <div className="mt-expand-row">
            ...
            <svg className="expand-arrow" viewBox="0 0 1024 1024" width="14" height="14">
              <path
                d="M512 714.667c-8.533 0-17.067-2.134-23.467-8.534L147.2 364.8c-12.8-12.8-12.8-32 0-44.8s32-12.8 44.8 0l320 314.667 320-314.667c12.8-12.8 32-12.8 44.8 0s12.8 32 0 44.8L535.467 706.133c-6.4 6.4-14.934 8.534-23.467 8.534z"
                fill="#999999"
              />
            </svg>
          </div>
